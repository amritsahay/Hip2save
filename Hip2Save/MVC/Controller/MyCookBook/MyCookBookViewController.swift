...
class MyCookBookViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        tracker.set(kGAIScreenName, value: "MyCookBookViewController")
    ...
    func createParam() -> Parameters
    {
        ...
        if searchBarHeight.constant > 0
        {
            parameters = [Key.option.rawValue:API.mycookbook.rawValue,Key.current_page.rawValue:current_page,Key.posts_per_page.rawValue:batch_size,Key.keyword.rawValue:searchBar.text!]
        }
        else
        {
            parameters = [Key.option.rawValue:API.mycookbook.rawValue,Key.current_page.rawValue:current_page,Key.posts_per_page.rawValue:batch_size]
        }
        return  parameters
    }
...
extension MyCookBookViewController:UITableViewDelegate,UITableViewDataSource
{
...
extension MyCookBookViewController:UISearchBarDelegate
{
